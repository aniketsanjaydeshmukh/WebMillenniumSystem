        ...
        <div class="col-lg-12">
            <div class="fixed-page-header">
                <div class="page-header clearfix">
                    <h1 class="page-head-text pull-left"><spring:message code="label.tokensNameValue"/></h1>
    ...
    <div class="row">                        
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/tokensNameValue.html" class="form-horizontal" >
                	...
                	<div class="table-responsive">
                        <table id="example" class="table table-bordered table-striped table-hover">
                          	<thead>
                            	<tr>
									<th>No</th>
                         			<th width="10%"><spring:message code="label.tokens"/></th>
                           	...
                           	<tbody>
                          		<c:forEach var="tokensName" items="${tokensNameList}" varStatus="status">
                          	      <tr>
                          	      	<td align="center">${status.count}</td>
                          	      	
                          	      	 <td><input type="hidden" name="tokensNameId" name="tokensNameId" id="tokensNameId" value="${tokensName.id}" />${tokensName.name}</td>
