            ...
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                 <c:if test="${hopper == 'hopper'}">
				   ...
				   <input type="hidden" name="mvid" id="mvid" value="${mvid}">
				   		<div class="form-group">
                        	<label  class="col-sm-3 control-label">Add No Of Hopper &#42;</label>
                        	<div class="col-sm-8">
				 ...
				 <c:if test="${ (empty hopper ) && (csv == 'coinSelector')}">
				   ...
				   <input type="hidden" name="mvid" id="mvid" value="${mvid}">
				   		<div class="form-group">
                        	<label  class="col-sm-3 control-label">Add No Of Coin Validator &#42;</label>
                        	<div class="col-sm-8">
				...
				<c:if test="${ (empty hopper ) && (empty csv ) && (bv == 'billValidator')}">
				   ...
				   <input type="hidden" name="mvid" id="mvid" value="${mvid}">
				   		<div class="form-group">
                        	<label  class="col-sm-3 control-label">Add No Of Bill Validator &#42;</label>
                        	<div class="col-sm-8">
