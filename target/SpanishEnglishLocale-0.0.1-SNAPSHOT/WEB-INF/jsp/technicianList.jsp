                          ...
                          <tbody>
                          	<c:forEach var="technician" items="${technicianList}">
                                <tr>
                                    ...
                                    <td><button type="submit" class="btn btn-default btn-sm" onClick="editSchool('${technician.id}','${technician.technicianName}','${technician.address}','${technician.phone}');"><i class="fa fa-pencil-square-o"></i> <spring:message code="label.edit"/></button></td>
                                 </tr>
                          	</c:forEach>                                                                                    
                          </tbody>
                        </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
             ...
             <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/establishment/technician.html" commandName="technician">
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <form:label path="phone" class="col-sm-3 control-label"><spring:message code="label.telephone"/> &#42;</form:label>
                        <div class="col-sm-8">
                            <form:input type="text" path="phone" id="phone" value="" class="form-control" maxlength="60" onblur = "useHTML(this.id,document.getElementById('c').value)"/>
                      	</div>
                    </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><spring:message code="label.editTechnician"/> </h4>
	        ...
	        <form:form id="editForm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/establishment/technician.html" commandName="technician">
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <form:label path="phone" class="col-sm-3 control-label"><spring:message code="label.telephone"/> &#42;</form:label>
                        <div class="col-sm-8">
                            <form:input type="text" path="phone" id="phonee" value="" class="form-control" maxlength="60" onblur = "useHTML(this.id,document.getElementById('c').value)"/>
                      	</div>
                    </div>
           			 <div class="modal-footer text-center">
            	<button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><spring:message code="label.cancel"/></button>
