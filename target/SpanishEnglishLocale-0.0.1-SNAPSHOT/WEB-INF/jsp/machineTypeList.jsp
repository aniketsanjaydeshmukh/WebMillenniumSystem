    ...
    $('#frm').formValidation({
        ...
        fields: {
        	machineTypeName: {
                validators: {
                    notEmpty: {
                        message: 'The Machine Type name is required'
                    }
                }
            },
            paymentDevices: {
                validators: {
                    notEmpty: {
                        message: 'The Payment Devices is required'
                    }
                }
            }
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
         	...
         	<th width="3%" class="text-center no-sort"><input type="checkbox"  onClick="deleteAllRow(this)" ></th>
                                <th width="10%"><spring:message code="label.machineTypeName"/></th>
                          ...
                          <tbody>
                          	<c:forEach var="machineType" items="${machineTypeList}">
                                <tr>
                                    ...
                                    <td>
                                    	<c:forEach var="temp" items="${machineType.paymentDevices}">
									        <c:out value="${temp}"></c:out>,
									    </c:forEach>
                                    </td>
                                   
                                    <td><button type="submit" class="btn btn-default btn-sm" onClick="editSchool('${machineType.id}','${machineType.machineTypeName}','${machineType.paymentDevices}');"><i class="fa fa-pencil-square-o"></i> <spring:message code="label.edit"/></button></td>
                                 </tr>
                          	</c:forEach>                                                                                    
                          </tbody>
                        </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
             ...
             <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/machineType.html" commandName="machineType">
            <div class="modal-body">
                
                      	<input type="hidden" name="action" id="action" value="add">
                    <div class="form-group">
                        <form:label path="machineTypeName" class="col-sm-3 control-label"><spring:message code="label.machineTypeName"/> &#42;</form:label>
                        <div class="col-sm-8">
                       		<form:input type="text" path="machineTypeName" id="machineTypeName" name="machineTypeName" value="" class="form-control" maxlength="50" onblur = "useHTML(this.id,document.getElementById('a').value)"/>
                       	</div>
                    </div>
                  	
             		
             		<div class="form-group">
                    <form:label path="paymentDevices" class="col-sm-3 control-label"><spring:message code="label.paymentDevices"/> &#42;</form:label>
                    	<div class="col-sm-8">
		                    	<form:select path="paymentDevices" id="paymentDevices" multiple = "true">
		                    		  <option value="Hopper"><spring:message code="label.hopper"/></option>
									   <option value="CoinSelector"><spring:message code="label.coinSelector"/></option>
									   <option value="BillValidator"><spring:message code="label.billValidator"/></option>
		                    	</form:select>
                    	</div>
                    </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><spring:message code="label.editCountry"/> </h4>
	        ...
	        <form:form id="editForm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/machineType.html" commandName="machineType">
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <form:label path="machineTypeName" class="col-sm-3 control-label"><spring:message code="label.country"/> &#42;</form:label>
                        <div class="col-sm-8">
                       		<form:input type="text" path="machineTypeName" id="machineTypeNamee" name="machineTypeNamee" value="" class="form-control" maxlength="50" onblur = "useHTML(this.id,document.getElementById('a').value)"/>
                       	</div>
                    </div>
                  	<div class="form-group">
                    <form:label path="paymentDevices" class="col-sm-3 control-label"><spring:message code="label.paymentDevices"/> &#42;</form:label>
                    	<div class="col-sm-8">
		                    	<form:select path="paymentDevices" id="paymentDevicess" multiple = "true">
		                    		  <option value="Hopper"><spring:message code="label.hopper"/></option>
									   <option value="CoinSelector"><spring:message code="label.coinSelector"/></option>
									   <option value="BillValidator"><spring:message code="label.billValidator"/></option>
		                    	</form:select>
