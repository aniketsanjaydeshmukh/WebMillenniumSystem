...
<script>
 ...
 function showBtn(){
	 ...
	 if(saveKara == 0){
		 ...
		 if(result){
			 window.location.href = "deleteTokensList.html?list="+saveKara;	 
		 }
        ...
        <div class="col-lg-12">
            <div class="fixed-page-header">
                <div class="page-header clearfix">
                    <h1 class="page-head-text pull-left"><spring:message code="label.token"/></h1>
                    
                    <button type="submit" class="btn btn-inverse btn-sm pull-right" data-toggle="modal" data-target="#schoolAdd"><i class="fa fa-plus-circle"></i>  <spring:message code="label.addToken"/></button>                    
            ...
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                   <div class="panel-name">
                        <span class="panel-head"><spring:message code="label.tokenList"/></span>
                    </div>                                        
                </div>
                <!-- /.panel-heading -->
         	...
         	<th width="3%" class="text-center no-sort"><input type="checkbox"  onClick="deleteAllRow(this)" ></th>
                                ...
                                <th width="10%"><spring:message code="label.tokenName"/></th>
                               
                                <th width="10%"><spring:message code="label.edit"/></th>
                            </tr>
                          </thead>
                          <tbody>
                          	<c:forEach var="tokenName" items="${tokensNameList}">
                                <tr>
                                  	<td class="text-center"><input type="checkbox" id="${tokenName.id}"  name="myTextEditBox" value="" onClick="displayNote(event)"/></td>
                                    <td>${tokenName.name}</td>
                                  
                                    <td><button type="submit" class="btn btn-default btn-sm" onClick="editSchool('${tokenName.id}','${tokenName.name}');"><i class="fa fa-pencil-square-o"></i> <spring:message code="label.edit"/></button></td>
                                 </tr>
                          	</c:forEach>                                                                                    
                          </tbody>
                        </table>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><center><spring:message code="label.tokenDetails"/></center></h4>
            </div>
           
          <form:form id="frm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/tokens.html" commandName="tokensName">
            <div class="modal-body">
                
                      	<input type="hidden" name="action" id="action" value="add">
                    <div class="form-group">
                        <form:label path="name" class="col-sm-3 control-label"><spring:message code="label.tokenName"/> &#42;</form:label>
                        <div class="col-sm-8">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><spring:message code="label.editToken"/> </h4>
      </div>
	   
	        <form:form id="editForm" class="form-horizontal" method="POST" name="frm" action="${pageContext.request.contextPath}/admin/tokens.html" commandName="tokensName">
            <div class="modal-body">
